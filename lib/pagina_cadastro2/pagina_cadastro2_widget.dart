...
class PaginaCadastro2Widget extends StatefulWidget {
  const PaginaCadastro2Widget({Key? key}) : super(key: key);

  @override
  _PaginaCadastro2WidgetState createState() => _PaginaCadastro2WidgetState();
}

class _PaginaCadastro2WidgetState extends State<PaginaCadastro2Widget> {
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    20, 10, 20, 0),
                                            child: Text(
                                              'Preencha o endereço de onde você mora.',
                                              textAlign: TextAlign.start,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyText1
